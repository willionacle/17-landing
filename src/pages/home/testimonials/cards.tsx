...
export default function Cards() {
  ...
  return (
    ...
    >
      ...
      <CarouselPrevious className="-left-10 backdrop-blur-sm lg:left-0 lg:backdrop-blur-none cursor-pointer" />
      <CarouselNext className="-right-10 backdrop-blur-sm lg:right-0 lg:backdrop-blur-none cursor-pointer" />
    </Carousel>
  );
}
